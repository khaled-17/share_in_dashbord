  ...
  const expenseColumns = [
    {
      key: "exp_date",
      header: "التاريخ",
      render: (e: Expense) => formatDate(e.exp_date),
    },
    {
      key: "amount",
      header: "المبلغ",
      render: (e: Expense) => formatAmount(e.amount),
    },
    {
      key: "type",
      header: "النوع",
      render: (e: any) => e.type?.exptype_name || e.exptype_id,
    },
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card title="سجل المصروفات">
            <Table
              ...
              data={expenses}
              emptyMessage="لا يوجد سجل مصروفات لهذا المورد"
            />
          </Card>
        </div>
      </div>
